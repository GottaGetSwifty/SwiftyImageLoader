...
//        ImageCacheManager.sharedInstance.fadeAnimationDuration = 0.0
        
        // Uncomment to set a custom timeout interval for the image requests.
//        ImageCacheManager.sharedInstance.timeoutIntervalForRequest = 15.0
        
        // Uncomment to set a custom request cache policy for the image requests as well as the session's configuration.
//        ImageCacheManager.sharedInstance.requestCachePolicy = .useProtocolCachePolicy
        
        // Uncomment to disable file system caching.
//        ImageCacheManager.sharedInstance.diskCacheMaxAge = 0
//        ImageCacheManager.sharedInstance.requestCachePolicy = .reloadIgnoringLocalCacheData
